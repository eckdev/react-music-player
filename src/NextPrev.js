function NextPrev({type,selectNextPrevTrack}) {
    return(
        <div className="player-controls__item">
            {type === 'prev' ? 
            <svg id="icon-prev" viewBox="0 0 32 32" className="icon" onClick={() => selectNextPrevTrack()}>
          <title>prev</title>
        ...
        <svg id="icon-next" viewBox="0 0 32 32" className="icon" onClick={() => selectNextPrevTrack()}>
          <title>next</title>
